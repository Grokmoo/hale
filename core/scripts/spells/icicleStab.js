...
function onTargetSelect(game, targeter) {
	...
	g1.setVelocityDurationRotationBasedOnSpeed(parent.getPosition(), targeter.getEndPoint(), 800.0);
	
	var g2 = game.getBaseParticleGenerator("bolt");
	g2.setVelocityDurationBasedOnSpeed(parent.getPosition(), targeter.getEndPoint(), 800.0);
