...
public class SavedParty {
	...
	public SavedParty(String id) {
		String resourceLocation = "characters/parties/" + id + ResourceType.JSON.getExtension();
	...
	/**
	 * Returns the amount of currency currently owned by this party, in CP
	 * @return the amount of currency owned by the party
	 */
	
	public int getCurrencyInCP() { return currencyInCP; }
	...
	/**
	 * Writes the contents of this SavedParty to a file in the default location,
	 * "characters/parties/" + id + ".json"
	 */
	
	public void writeToFile() {
		File file = new File("characters/parties/" + id + ResourceType.JSON.getExtension());
		...
		try {
			...
			// write the JSON data
			obj.writeJSONString(out, JSONStyle.NO_COMPRESS);
